    ...
    final content = Column(
      ...
      children: [
        ...
        if (widget.header != null) ...[
          Padding(
            padding: widget.padding ?? const EdgeInsets.fromLTRB(20, 18, 20, 12),
            child: widget.header,
          ),
        ...
        ...widget.children.asMap().entries.map((e) => Column(
          children: [
            Padding(
              padding: widget.padding ?? const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
              child: e.value,
            ),
            if (e.key < widget.children.length - 1) const Divider(height: 1, thickness: 0.5),
          ],
        )),
      ],
    );
