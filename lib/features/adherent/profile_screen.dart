                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: AppTheme.primary.withValues(alpha: 0.3), blurRadius: 20, offset: Offset(0, 8)),
                      ],
                    ),
                    child: Center(child: Text(initials, style: const TextStyle(color: AppTheme.primary, fontSize: 28, fontWeight: FontWeight.w700))),
                  ),
                  const SizedBox(height: 12),
                  Text(user?.fullName ?? '', style: AppTheme.headingLarge),
                  const SizedBox(height: 4),
                  Text('Adhérent', style: TextStyle(color: AppTheme.primary.withValues(alpha: 0.8), fontSize: 13, fontWeight: FontWeight.w500)),
                ]),
              ),
            ),
          ),
