              ...
              Container(
                ...
                child: Row(children: [
                  Container(
                    ...
                    child: const Icon(Icons.psychology, color: AppTheme.primary, size: 32),
                  ),
                  const SizedBox(width: 16),
                  const Expanded(child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Coach IA personnalisé', style: TextStyle(color: AppTheme.textPrimary, fontWeight: FontWeight.w700, fontSize: 18)),
                      SizedBox(height: 6),
              ...
              if (_error != null) ...[
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Text(_error!, style: const TextStyle(color: AppTheme.error, fontSize: 14))),
                  ]),
                ),
